				...
				<div class="intro-form-exchange">
                    <form method="post" id="myform" name="myform" class="currency_validate trade-form row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <span class="error" id="phoneValidation">Enter your phone number.</span>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <span class="error" id="fnameValidation">Enter your first name.</span>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <span class="error" id="lnameValidation">Enter your last name.</span>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <span class="error" id="deliveryAddressValidation">Enter a delivery address.</span>
                        </div>
                        ...
                        <div class="col-12">
                          <div class="g-recaptcha" data-sitekey="6LerRP8cAAAAAFBPsV0wwkFSwwPXnZcd--_TfDWo"></div>
                          <span class="error" id="captchaValidation">Verify that you are not a robot.</span>
                        </div>
...
$(document).ready(function() {
      window.addEventListener('load', async () => {
        if (window.ethereum) {
          ...
          try {
            ...
            document.getElementById("walletAddress").setAttribute('value',bscacc);
          } catch (err) {
      ...
      $('#buy-button').click(function(){
        ...
        if(deliveryAddress== ''){
          $('#deliveryAddressValidation').show();
          return false;
        }
